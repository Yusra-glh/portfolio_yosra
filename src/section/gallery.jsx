                 ...
                 <Masonry
                    ...
                    <div className="col-lg-4 image-element-class de_modal de_modal" onClick={handleBtnClick}
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/photolink/logo.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick1}
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/car for her/logo.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick2}
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/book and boat/logo.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick}
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/raven/icon.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick1}
                        data-aos="fade-up"
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/beem smart taxi/icon.jpg" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick2}
                        data-aos="fade-up"
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/aspar/logo.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick2}
                        data-aos="fade-up"
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/rest4u/logo.svg" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick2}
                        data-aos="fade-up"
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/beem smart driver/icon.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick2}
                        data-aos="fade-up"
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/irama/logo.png" alt="gallery"/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick2}
                        data-aos="fade-up"
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/portfolio/bagzee/bagzee.png" alt="gallery"/>
                        </div>
                    </div>
                  </Masonry>
